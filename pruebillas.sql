...
--
-- Host: localhost    Database: pruebillas
-- ------------------------------------------------------
...
CREATE TABLE `gente` (
  ...
  `nombres_apellidos` text DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `gente` VALUES (1,'11111111-1','claudio guzman'),(2,'22222222-2','karina gonzalez');
...
-- Dump completed on 2021-10-20 10:13:13
